import { SimEvent, EventCategory } from './eventTypes.js';

// 이벤트 핸들러 타입 정의
export type EventHandler<T = any> = (event: SimEvent<T>) => void | Promise<void>;
...
export class EventBus implements IEventBus {
    ...
    private async handleEvent(event: SimEvent) {
        // 1. 타입별 핸들러 실행
