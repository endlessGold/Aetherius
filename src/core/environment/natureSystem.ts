...
export class NatureSystem {
  ...
  private processChunk(chunk: Float32Array, cx: number, cy: number, w: number, h: number, tick: number) {
  ...
  // Legacy methods (diffuse, advect, etc.) are currently disabled or need refactoring for chunk system
  // private diffuse(...) {}
  // private advect(...) {}
  // private updateWind(...) {}
  // private cycleWater(...) {}
  // private applySunlight(...) {}
}
