...
Output: A short narrative paragraph about the past.`;
        return await this.control.generateResponse(prompt, 'You are a historian. You turn event logs and snapshots into a brief, readable story of what came before.');
    }
}
...
Output: A short live-cast paragraph about the present—engaging and curious, like a streamer or reporter.`;
        ...
        return await this.control.generateResponse(prompt, systemPrompt);
    }
}
